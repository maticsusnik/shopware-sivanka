...
/**
 * Loads the optional media entity of the "sivanka-service-card" CMS element.
 ...
 */
class SivankaServiceCardResolver extends AbstractCmsElementResolver
{
    private const MEDIA_KEY = 'media';

    public function getType(): string
    {
        return 'sivanka-service-card';
    }
